...
type EventRecords struct {
	...
	Assets_Created                                  []EventAssetCreated                             //nolint:stylecheck,golint
	Assets_Issued                                   []EventAssetIssued                              //nolint:stylecheck,golint
	Assets_Transferred                              []EventAssetTransferred                         //nolint:stylecheck,golint
	Assets_Burned                                   []EventAssetBurned                              //nolint:stylecheck,golint
	Assets_TeamChanged                              []EventAssetTeamChanged                         //nolint:stylecheck,golint
	Assets_OwnerChanged                             []EventAssetOwnerChanged                        //nolint:stylecheck,golint
	Assets_Frozen                                   []EventAssetFrozen                              //nolint:stylecheck,golint
	Assets_Thawed                                   []EventAssetThawed                              //nolint:stylecheck,golint
	Assets_AssetFrozen                              []EventAssetAssetFrozen                         //nolint:stylecheck,golint
	Assets_AssetThawed                              []EventAssetAssetThawed                         //nolint:stylecheck,golint
	Assets_Destroyed                                []EventAssetDestroyed                           //nolint:stylecheck,golint
	Assets_ForceCreated                             []EventAssetForceCreated                        //nolint:stylecheck,golint
	Assets_MetadataSet                              []EventAssetMetadataSet                         //nolint:stylecheck,golint
	Assets_MetadataCleared                          []EventAssetMetadataCleared                     //nolint:stylecheck,golint
	Assets_ApprovedTransfer                         []EventAssetApprovedTransfer                    //nolint:stylecheck,golint
	Assets_ApprovalCancelled                        []EventAssetApprovalCancelled                   //nolint:stylecheck,golint
	Assets_TransferredApproved                      []EventAssetTransferredApproved                 //nolint:stylecheck,golint
	Assets_AssetStatusChanged                       []EventAssetAssetStatusChanged                  //nolint:stylecheck,golint
	...
	ElectionProviderMultiPhase_SolutionStored       []EventElectionMultiPhaseSolutionStored         //nolint:stylecheck,golint
	ElectionProviderMultiPhase_ElectionFinalized    []EventElectionMultiPhaseElectionFinalized      //nolint:stylecheck,golint
	ElectionProviderMultiPhase_Rewarded             []EventElectionMultiPhaseRewarded               //nolint:stylecheck,golint
